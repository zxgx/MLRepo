...
import numpy as np
try:
    from implemention.utils.im2col_cython import col2im_cython, im2col_cython
    from implemention.utils.im2col_cython import col2im_6d_cython
except ImportError:
    print('run the following from the utils directory and try again:')
    print('python setup.py build_ext --inplace')
    print('You may also need to restart your iPython kernel')

from implemention.utils.im2col import *
